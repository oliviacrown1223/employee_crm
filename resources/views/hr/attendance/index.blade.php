...
@section('content')
                        ...
                        @forelse($employees as $employee)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- CHECK-IN --}}
                                    @if(auth()->user()->can('attendance.approve.all'))
                                        @if(!$attendance || !$attendance->check_in)

                                            <button class="btn btn-success btn-sm checkInBtn"
                                                    data-id="{{ $employee->id }}">
                                    ...
                                    @if($attendance)
                                        ...
                                        <a href="{{ route('hr.attendance.edit', $attendance->id) }}"
    ...
    <script>
        ...
        $('.checkInBtn').click(function(){
            ...
            $.post('/hr/attendance/check-in/' + id, {
        ...
        $('.checkOutBtn').click(function(){
            ...
            $.post('/hr/attendance/check-out/' + id, {
