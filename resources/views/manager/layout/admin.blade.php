    ...
    <div>
        ...
        <div class="sidebar-menu p-3">
            ...
            <a href="{{ route('manager.team.index') }}"
               class="{{ request()->routeIs('manager.team.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('manager.attendance') }}"
               class="{{ request()->routeIs('manager.attendance') ? 'active' : '' }}">
            ...
            <a href="{{ route('manager.tasks.index') }}"
               class="{{ request()->routeIs('manager.tasks.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('manager.performance.index') }}"
               class="{{ request()->routeIs('manager.performance.*') ? 'active' : '' }}">
